...
class AuraxisEngine:
    ...
    def get_data_v10(self, ticker="EURUSD=X"):
        try:
            # Busca dados históricos para os cálculos de Z-Score e ATR
            ...
            # Cálculo de Pips (Baseado no fechamento de ontem)
            ...
            return pd.DataFrame(), 0.0, 0.0, str(e)

    def calculate_radar(self, df, mode="DAY", trend_direction=0, p_refinado=None):
        # Usamos o preço refinado para todos os cálculos de gatilho
